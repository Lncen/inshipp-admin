...
const [Grid, gridApi] = useVbenVxeGrid({
  ...
  } as VxeTableGridOptions<UserApi.UserInfo>,
});

function onActionClick(e: OnActionClickParams<UserApi.UserInfo>) {
  switch (e.code) {
    case 'delete': {
      onDelete(e.row);
      break;
...
function onEdit(row: UserApi.UserInfo) {
  formDrawerApi.setData(row).open();
}

function onDelete(row: UserApi.UserInfo) {
